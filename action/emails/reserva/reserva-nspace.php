<?php
    ...
    // $objReserva = Doctrine_Core::getTable('Reserva')->find(173);
?>
                        ...
                        <tr>
                            <td>
                                <div style="text-align: center; padding: 40px 0px;">
                                    ...
                                    <p style="margin: 0px 0px 10px;">Temos uma nova reserva no site, segue abaixo os dados:</p>
...
<?php
    ...
    try {
        ...
        $mail->AddAddress('atendimento@nspace.com.br');
