                        ...
                        <tr>
                            <td>
                                <div style="text-align: center; padding: 40px 0px;">
                                    ...
                                    <p style="margin: 0px 0px 10px;">Seja bem vindo ao NSPACE, agora você já pode acessar e efetuar reservas.</p>
                                    ...
                                    <div style="margin-top: 40px; text-align: left;">
                                        <div style="display: block; margin-bottom: 10px; text-align: center;">
                                            ...
                                            padding: 10px 32px;
                                            border-radius: 6px;" href="<?php echo URL ?>?ref=login">Acessar site</a>
                                        </div>  
                                    </div>
                                </div>
                            </td>
