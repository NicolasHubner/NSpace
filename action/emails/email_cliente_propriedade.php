                        ...
                        <tr>
                            <td>
                                <div style="text-align: center; padding: 40px 0px;">
                                    ...
                                    <p style="margin: 0px 0px 10px;">Obrigado por cadastrar seu espaço em nosso portal! Segue abaixo os dados cadastrados:</p>
...
<?php
    ...
    try {
        ...
        $mail->Subject = 'Cadastro de espaço - Nspace';
        $mail->Body = $obContent;
        $mail->CharSet = 'utf-8';
        $mail->send();
