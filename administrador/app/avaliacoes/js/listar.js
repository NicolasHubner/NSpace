$(document).ready(function(){
	...
	$('.data-table').dataTable({
		...
		"bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": URL_ADMIN+"action.php?model=avaliacoes&action=listar",
                "aoColumns": [
                        { "mDataProp": "data_cadastro", "sName": "data_cadastro" },
                        { "mDataProp": "Cliente.nome", "sName": "c.nome" },
                        { "mDataProp": "avaliacao", "sName": "a.avaliacao" },
                        { "mDataProp": "Reserva.id", "sName": "a.reserva_id" },
                	{ "mDataProp": "status", "sName": "status" },
