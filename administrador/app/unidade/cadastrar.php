			...
			<form class="form" action="<?php echo URL_ADMIN.'action/'.$_GET['model'].'/'.$_GET['action'].'/'; ?>" method="POST" id="form" enctype="multipart/form-data">
				<div class='row'>
                    <div class="col-md-3">
                     ...
                     <div class="col-md-3">
                        ...
                        <input type="text" class="form-style" name="nome_responsavel" id="nome_responsavel">
                    </div>

                    <div class="col-md-3">
						<label>Tipo:</label><br>
                        <label class="radio-inline"> <input class="icheck" type="radio" class="validate[required]" name="tipo" value='Filial' checked> Filial</label> 
                        <label class="radio-inline"> <input class="icheck" type="radio" class="validate[required]" name="tipo" value='Matriz'> Matriz</label> 
					</div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="whatsapp" id="whatsapp" class="form-style" data-mask="(99) 99999-9999" />
                    </div>
                </div>
