...
try {
	...
	$retAll		= 	Doctrine_Query::create()->select()->from('Unidade u')->leftJoin('u.Estado e')->leftJoin('u.Cidade c')
					->where($where);
	$retLimit	= 	Doctrine_Query::create()->select()->from('Unidade u')->leftJoin('u.Estado e')->leftJoin('u.Cidade c')
