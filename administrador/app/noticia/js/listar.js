$(document).ready(function(){
	...
	$('.data-table').dataTable({
		...
		"bProcessing": true,
                'aaSorting' :[[0, "asc"]],
        "bServerSide": true,
        "sAjaxSource": URL_ADMIN+"action.php?model=noticia&action=listar",
        "aoColumns": [
                { "mDataProp": "data_cadastro", "sName": "n.data_cadastro" },
                { "mDataProp": "titulo", "sName": "n.titulo" },
                { "mDataProp": "status", "sName": "n.status" },
                { "mDataProp": "destaque", "sName": "n.destaque" },
                { "mDataProp": "imagem", "sName": "n.imagem" },
