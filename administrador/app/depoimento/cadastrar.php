	...
	<div class="col-md-12">
        <div class="block-flat">
			...
			<form class="form" action="<?php echo URL_ADMIN.'action/'.$_GET['model'].'/'.$_GET['action'].'/'; ?>" method="POST" id="form" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-md-12">
						<label>Texto:</label> Caracteres disponíveis: <span class="contadorCaracter">140</span>
						<input type="text" name="texto"  class="form-style validate[required]" />
					</div>
				</div>
