		...
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<div class="sec-heading center">
					<h2>TOP Anúncios</h2>
					<p>Locais em destaque perto de você</p>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<div class="property-slide">
					<?php 
						$retAnuncio = Doctrine_Query::create()->select()->from('Anuncio')->where('status_id = 2 and pagamento = 1 and top_anuncio = 1')->limit(20)->execute();
